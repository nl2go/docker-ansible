...
def prompt_encryption_password():
    return getpass.getpass(prompt='Enter decryption password for .vault-password files: ', stream=None)
...
def encrypt_vault_password_file(vault_password, encryption_password, encrypted_vault_password_file):
...
def decrypt_vault_password_file(encryption_password, encrypted_vault_password_file, vault_password_file):
...
def decrypt_vault_password_files(encrypted_vault_password_files):
    ...
    for encrypted_vault_password_file in encrypted_vault_password_files:
        ...
        decrypt_vault_password_file(encryption_password, encrypted_vault_password_file, vault_password_file)
...
def init():
    base_dir = os.getcwd()
    encrypted_vault_password_files = get_encrypted_vault_password_files(base_dir)
    if encrypted_vault_password_files:
        ...
        print('Skpping Anisble Vault password decryption. No .vault-password files were found!')
